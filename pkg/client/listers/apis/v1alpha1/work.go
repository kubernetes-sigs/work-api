...
type WorkLister interface {
	...
	List(selector labels.Selector) (ret []*apisv1alpha1.Work, err error)
...
type workLister struct {
	listers.ResourceIndexer[*apisv1alpha1.Work]
}

// NewWorkLister returns a new WorkLister.
func NewWorkLister(indexer cache.Indexer) WorkLister {
	return &workLister{listers.New[*apisv1alpha1.Work](indexer, apisv1alpha1.Resource("work"))}
}

// Works returns an object that can list and get Works.
func (s *workLister) Works(namespace string) WorkNamespaceLister {
	return workNamespaceLister{listers.NewNamespaced[*apisv1alpha1.Work](s.ResourceIndexer, namespace)}
}
...
type WorkNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apisv1alpha1.Work, error)
